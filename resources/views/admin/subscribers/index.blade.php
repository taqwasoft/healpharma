                    ...
                    <table class="table" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="table-header-content d-print-none">{{ __('Gateway Method') }}</th>
...
@push('modal')
    @include('admin.subscribers.approved')
    @include('admin.subscribers.rejected')
    @include('admin.subscribers.view')
@endpush
