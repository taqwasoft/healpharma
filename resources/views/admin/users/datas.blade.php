@foreach ($users as $user)
    <tr class="table-content">
        ...
        <td class="text-start table-single-content">{{ formatted_date($user->created_at) }}</td>
        ...
        <td class="text-center">
            <label class="switch">
                <input type="checkbox" {{ $user->status == 'active' ? 'checked' : '' }} class="userStatus"
                    data-url="{{ route('admin.users.status', $user->id) }}">
