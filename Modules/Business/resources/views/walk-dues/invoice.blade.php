...
@section('main_content')
 <div class="invoice-container-sm">
    <div class="invoice-content">
        ...
        <div>
            <h4  class="company-name">{{ $walk_in_customer->dueCollect->business->companyName ?? '' }}</h4>
            <div class="company-info">
                ...
                @if (!empty($walk_in_customer->dueCollect->business->tax_name))
                    <p>{{ $walk_in_customer->dueCollect->business->tax_name }} : {{ $walk_in_customer->dueCollect->business->tax_no ?? '' }}</p>
                @endif
            </div>
        </div>
        ...
        <table class="ph-invoice-table">
            ...
            <tr>
                ...
                <th class="total-due">{{ __('Total Due') }}</th>
                <th>{{ __('Pay Amt ') }}</th>
                <th>{{ __('Due Amt ') }}</th>
            </tr>
            </thead>
