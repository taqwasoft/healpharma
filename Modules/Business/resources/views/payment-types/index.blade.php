            ...
            <div class="card">
                <div class="card-bodys">
                    <div class="table-header p-16">
                        ...
                        <a type="button" href="#payment-types-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2"><i class="fas fa-plus-circle me-1"></i>{{ __('Add new Payemnt Type') }}</a>
                    </div>
                    <div class="table-top-form ">
                        <form action="{{ route('business.payment-types.filter') }}" method="post" class="filter-form" table="#payment-types-data">
                            @csrf
                ...
                <div class="delete-item delete-show d-none">
                    <div class="delete-item-show">
                        ...
                        <button data-bs-toggle="modal" class="trigger-modal" data-bs-target="#multi-delete-modal" data-url="{{ route('business.payment-types.delete-all') }}">{{ __('Delete') }}</button>
                    </div>
                </div>
