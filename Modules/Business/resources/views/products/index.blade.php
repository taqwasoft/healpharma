            ...
            <div class="card ">
                <div class="card-bodys">
                    ...
                    <div class="table-top-form">
                        <form action="{{ route('business.products.filter') }}" method="post" onsubmit="return false" class="filter-form" table="#product-data">
                            @csrf
                            ...
                            <div class="table-top-left d-flex gap-3 ">
                                ...
                                <div class="table-search position-relative d-print-none">
                                    <input id="product-search-input--js" class="form-control searchInput" type="text" name="search"
                                        placeholder="{{ __('Search (min 2 chars)...') }}" value="{{ request('search') }}" autocomplete="off">
                                    <span class="position-absolute" id="product-search--js">
