                                    ...
                                    <div class="add-suplier-modal-wrapper d-block">
                                        <div class="row">
                                                ...
                                                <div class="gpt-up-down-arrow position-relative">
                                                    <select name="type_id" class="form-control table-select w-100 role">
                                                        ...
                                                        @foreach ($medicine_types as $type)
                                                            <option value="{{ $type->id }}"> {{ ucfirst($type->name) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <span></span>
                                                ...
                                                <div class="gpt-up-down-arrow position-relative">
                                                    <select name="manufacturer_id" class="form-control table-select w-100">
                                                        ...
                                                        @foreach ($manufactures as $manufacture)
                                                            <option value="{{ $manufacture->id }}"> {{ ucfirst($manufacture->name) }}</option>
                                                        @endforeach
                                                    </select>
                                                    <span></span>
                                                </div>
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <input type="text" name="meta[strength]" class="form-control" placeholder="{{ __('Enter Strength') }}">
                                            </div>
                                            @endif
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <input type="text" name="meta[generic_name]" class="form-control" placeholder="{{ __('Enter Generic Name') }}">
                                            </div>
                                            @endif
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <input type="text" name="meta[shelf]" class="form-control" placeholder="{{ __('Enter Shelf') }}">
                                            </div>
                                            @endif
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                ...
                                                <textarea name="meta[medicine_details]" class="form-control" placeholder="{{ __('Enter Medicine Details') }}"></textarea>
                                            </div>
                                            @endif
                                            ...
                                            <div class="dual-dropdown">
                                                <select id="vat_id" name="tax_id">
                                                    ...
                                                    @foreach ($taxes as $tax)
                                                        <option value="{{ $tax->id }}" data-vat_rate="{{ $tax->rate }}">
                                                            {{ $tax->name }} ({{ $tax->rate }}%)
                                                        </option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="single-container order-form-section m-3 pb-3 mt-0 mb-0">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="gpt-up-down-arrow position-relative">
                                            <select id="vat_type" name="tax_type" class="form-control table-select w-100">
                                                <option value="exclusive">{{ __('Exclusive') }}</option>
                                                <option value="inclusive">{{ __('Inclusive') }}</option>
                                            </select>
                                            <span></span>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="gpt-up-down-arrow position-relative">
                                            <select id="vat_id" name="tax_id" class="form-control table-select w-100">
                                                <option value="">{{ __('Select one') }}</option>
                                                @foreach ($taxes as $tax)
                                                    <option value="{{ $tax->id }}" data-vat_rate="{{ $tax->rate }}">
                                                        {{ $tax->name }} ({{ $tax->rate }}%)
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <input type="number" class="form-control productSalePrice" name="stocks[0][sales_price]" placeholder="{{__('Ex: 10')}}">
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <input type="number" name="stocks[0][wholesale_price]" class="form-control" placeholder="{{__('Ex: 10')}}">
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <input type="number" name="stocks[0][dealer_price]" class="form-control" placeholder="{{__('Ex: 10')}}">
                                    </div>
                                    @endif
                            ...
                            <div class="card-body">
                                @if (is_module_enabled($modules, 'show_product_image'))
                                    <div class="multiple-image-upload border rounded p-2">
                                        <div class="multiple-preview-container"></div>
