        ...
        <div class="mb-4 d-flex loss-flex  gap-3 loss-profit-container d-print-none">
            <div class="d-flex align-items-center justify-content-center gap-3">
                <div class="profit-card p-3 text-white">
                    ...
                    <p class="stat-value" id="total_sale_return">{{ currency_format($total_sale_return, 'icon', 2, business_currency()) }}</p>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-bodys">
                ...
                <div class="table-top-form">
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        <form action="{{ route('business.sale-return-reports.filter') }}" method="post" class="report-filter-form" table="#sale-return-reports-data">
                            @csrf
                    ...
                    <div class="table-top-btn-group d-print-none">
                        <ul>
                            <li>
                                <a href="{{ route('business.sales-return-report.csv') }}">
                                    <img src="{{ asset('assets/images/icons/cvg.svg') }}" alt="">
                                </a>
                            </li>

                            <li>
                                <a href="{{ route('business.sales-return-report.excel') }}">
