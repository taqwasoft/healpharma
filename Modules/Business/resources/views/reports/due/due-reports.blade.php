        ...
        <div class="card">
            <div class="card-bodys">
                ...
                <div class="table-top-form">
                    <form action="{{ route('business.due-reports.filter') }}" method="post" class="filter-form" table="#due-reports-data">
                        @csrf
            ...
            <div class="responsive-table table-container">
                <table class="table" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="text-start table-header-content">{{ __('Email') }}</th>
                        <th class="text-start table-header-content">{{ __('Phone') }}</th>
                        <th class="text-start table-header-content">{{ __('Type') }}</th>
