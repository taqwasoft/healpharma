            ...
            <div class="card-bodys">
                ...
                <div class="table-top-form ">
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        <form action="{{ route('business.expense-reports.filter') }}" method="post" class="report-filter-form" table="#expense-reports-data">
                            @csrf
            ...
            <div class="responsive-table table-container">
                <table class="table" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="text-start table-header-content">{{ __('Expense For') }}</th>
                        ...
                        <th class="text-start table-header-content">{{ __('Expense Date') }}</th>
                    </tr>
                    </thead>
