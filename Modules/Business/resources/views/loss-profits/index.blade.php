                ...
                <div class="card-bodys">
                    ...
                    <div class="table-top-form">
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            <form action="{{ route('business.loss-profits.filter') }}" method="post" class="report-filter-form" table="#loss-profit-data">
                                @csrf
                    ...
                    <table class="table" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-start table-header-content">{{ __('Invoice') }}</th>
                                <th class="text-start table-header-content">{{ __('Name') }}</th>
                                <th class="text-start table-header-content">{{ __('Total') }}</th>
                                <th class="text-start table-header-content">{{ __('Loss/Profit') }}</th>
                                <th class="text-start table-header-content">{{ __('Date') }}</th>
                                <th class="text-start table-header-content">{{ __('Status') }}</th>
                            </tr>
                        </thead>
