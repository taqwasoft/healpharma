@foreach($sales as $sale)
    ...
    <tr>
        ...
        <td class="table-single-content">{{ currency_format($sale->totalAmount, 'icon', 2, business_currency()) }}</td>
        <td class="table-single-content">{{ currency_format($sale->paidAmount, 'icon', 2, business_currency()) }}</td>
