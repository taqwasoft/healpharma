        ...
        <div class="mb-4 d-flex loss-flex  gap-3 loss-profit-container d-print-none">
            <div class="d-flex align-items-center justify-content-center gap-3">
                ...
                <div class="loss-card p-3 text-white">
                    <p class="stat-title">{{ __('Stock Value') }}</p>
            ...
            <div class="responsive-table table-container">
                <table class="table" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="text-start table-header-content">{{ __('Product') }}</th>
                        <th class="text-start table-header-content">{{ __('Cost') }}</th>
                        <th class="text-start table-header-content">{{ __('Qty') }}</th>
                        <th class="text-center table-header-content">{{ __('Sale') }}</th>
                        <th class="text-end table-header-content">{{ __('Stock Value') }}</th>
                    </tr>
                    </thead>
                    <tbody id="stock-data">
